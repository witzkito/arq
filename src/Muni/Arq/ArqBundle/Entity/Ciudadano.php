 ...
 * Ciudadano
 *
 * @ORM\Table(name="Arq_Ciudadano")
 * @ORM\Entity(repositoryClass="Muni\Arq\ArqBundle\Entity\CiudadanoRepository")
 */
class Ciudadano
{
    /**
     ...
     * @var string
     *
     * @ORM\Column(name="barrio", type="string", length=100, nullable=false)
     */
    private $barrio;
